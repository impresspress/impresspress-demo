...
export const handle_request: (a: number) => number;
export const initialize: (a: number) => number;
...
export const __wasm_bindgen_func_elem_24144: (a: number, b: number, c: number, d: number) => void;
export const __wasm_bindgen_func_elem_24146: (a: number, b: number, c: number, d: number) => void;
